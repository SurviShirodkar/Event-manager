            ...
            <tbody>
                {
                    ...
                    <td>{obj.email}</td>
                    <td>{obj.event}</td>
                    <td><button onClick = {() =>{setModalState(true) ; setEditDetails(obj)}} >E</button></td>
                    <td><button onClick = {()=>deleteRow(num)}  className="analysis-delete">D</button></td>
                    </tr>)
                }
